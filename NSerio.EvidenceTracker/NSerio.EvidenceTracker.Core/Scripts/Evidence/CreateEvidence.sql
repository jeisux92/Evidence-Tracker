...
VALUES (@ArtifactTypeID, @Workspace, @Workspace, GETDATE(), @User, GETDATE(), @User, 1, 1, @Name, '', '', 0)

DECLARE @ArtifactID INT = SCOPE_IDENTITY()

INSERT INTO [EDDSDBO].[EvidenceTracker] (ArtifactID, Name, Latitude, Longitude, [Date], [Case])
VALUES (@ArtifactID, @Name, @Latitude, @Longitude, @Date, @Case)
